        ...
        <div class="color-line">
            <form action="index.php">
                <div class="color1">
                    ...
                    <select name="ring1" class="colors-select color-select1">
                    ...
                    <select name="ring2" class="colors-select color-select2">
                    ...
                    <select name="ring3" class="colors-select color-select3">
                    ...
                    <select name="ring4" class="colors-select color-select4">
